...
export const InspectionSettingsModal = ({ showModal, onClose }: InspectionSettingsModalProps) => {
    ...
    return (
        <CustomModal isVisible={showModal} onClose={onClose} title={trans('timerSettings.editInspection')} size="lg">
                ...
                <SettingItem>
                    <SettingsSwitchItem
                        ...
                        subtitle={trans('timerSettings.inspectionAlertDesc')
                            ...
                            .replace('%2%', Math.ceil(timerSettings.inspectionTime * INSPECTION_TIME_THRESHOLDS[1]))}
                    />
                    ...
                    {timerSettings.inspectionAlerts !== 'none' && (
                        <SettingItem showBorder={false}>
                            <View style={styles.settingContainer}>
                                ...
                                <LinkButton
                                    textStyle={{ fontSize: FONTS.md }}
                                    title={trans(`timerSettings.inspectionTimeAlert-${timerSettings.inspectionAlerts}`)}
                                    onPress={() => setShowTimeModal(true)}
                                    color={getColor('primary200')}
                                />
                            </View>
